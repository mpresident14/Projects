...
public class WinPercentages extends AppCompatActivity implements View.OnClickListener{
    ...
    ArrayList<Card> player1_cards = new ArrayList<Card>();
    ArrayList<Card> player2_cards = new ArrayList<Card>();
    ArrayList<Card> player3_cards = new ArrayList<Card>();
    ArrayList<Card> player4_cards = new ArrayList<Card>();
    ArrayList<Card> player5_cards = new ArrayList<Card>();
    ArrayList<Card> player6_cards = new ArrayList<Card>();
    ArrayList<Card> player7_cards = new ArrayList<Card>();
    ArrayList<Card> player8_cards = new ArrayList<Card>();
    ArrayList<Card> player9_cards = new ArrayList<Card>();
    Player player1;
    Player player2;
    Player player3;
    Player player4;
