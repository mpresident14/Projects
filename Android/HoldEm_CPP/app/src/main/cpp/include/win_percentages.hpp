...
class WinPercentages{
    public:
        ...
        /*** Iterations ***/
        void getWinAndTiePercentages();
        void convertToPercentages(size_t* winCounts, size_t* tieCounts);
        void avgEmptyHands(double* winPercentages, double* c);
