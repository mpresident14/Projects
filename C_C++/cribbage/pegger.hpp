...
class Pegger{
    public:
        ...
        size_t scorePeg(Card*& card, std::vector<Card*>& board, size_t& runningTotal, bool print) const;
    ...
    private:
        ...
        bool makesTotal(Card*& card, size_t& runningTotal, size_t total) const; // returns true if adding card results in specified running total
        bool makesRunOpportunity(Card*& cardToPlay, std::vector<Card*>& board, size_t& runningTotal) const; 
        bool sub5StartNo10(Card*& cardToPlay, std::vector<Card*>& board, size_t& runningTotal) const;
