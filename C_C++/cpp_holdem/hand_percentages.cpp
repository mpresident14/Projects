...
double* HandPercentages::getHandPercentages() {
  /* Takes too long to calculate with 6 or 7 unknown cards, just use
   * predetermined percentages */
  // Zero cards
  if (player_.num_cards_ == 0) {  // To river
    if (flopTurnRiver_ == 5) {
      return new double[10]{17.4119, 43.8225, 23.4955,  4.82987,   4.61938,
                            3.02549, 2.5961,  0.168067, 0.0278507, 0.00323206};
    } else if (flopTurnRiver_ == 4) {  // To turn
      return new double[10]{32.4822,    47.7969,    12.4411,  3.59633,
                            1.77626,    1.01084,    0.815305, 0.0720288,
                            0.00813419, 0.000923446};
    }
  }
  // One card
    ...
    switch (val) {
      case 2:
        return new double[10]{17.9695,   44.4441,   23.5769, 4.84802,
                              3.34071,   3.03557,   2.5961,  0.168067,
                              0.0199895, 0.00102169};
      case 3:
        return new double[10]{17.6459,   44.0978,   23.5328, 4.83819,
                              4.06451,   3.03007,   2.5961,  0.168067,
                              0.0254866, 0.00102169};
      case 4:
        return new double[10]{17.3223,   43.7515,   23.4888, 4.82836,
                              4.78832,   3.02457,   2.5961,  0.168067,
                              0.0309837, 0.00102169};
      case 5:
        return new double[10]{16.9987,   43.4052,   23.4447, 4.81852,
                              5.51213,   3.01907,   2.5961,  0.168067,
                              0.0364808, 0.00102169};
      case 6:
        return new double[10]{17.1282, 43.4629, 23.4447,  4.81852,  5.32498,
                              3.01932, 2.5961,  0.168067, 0.036231, 0.00102169};
      case 7:
        return new double[10]{17.1282, 43.4629, 23.4447,  4.81852,  5.32498,
                              3.01932, 2.5961,  0.168067, 0.036231, 0.00102169};
      case 8:
      ...
      case 10:
        return new double[10]{16.9987,   43.4052,   23.4447, 4.81852,
                              5.51213,   3.01907,   2.5961,  0.168067,
                              0.0307338, 0.00676866};
      case 11:
        return new double[10]{17.3223,   43.7515,   23.4888, 4.82836,
                              4.78832,   3.02457,   2.5961,  0.168067,
                              0.0252367, 0.00676866};  // Jack
      case 12:
        return new double[10]{17.6459,   44.0978,   23.5328, 4.83819,
                              4.06451,   3.03007,   2.5961,  0.168067,
                              0.0197396, 0.00676866};  // Queen
      case 13:
        return new double[10]{17.9695,   44.4441,   23.5769, 4.84802,
                              3.34071,   3.03557,   2.5961,  0.168067,
                              0.0142425, 0.00676866};  // King
      case 14:
        return new double[10]{17.9695,   44.4441,   23.5769, 4.84802,
                              3.34071,   3.03557,   2.5961,  0.168067,
                              0.0142425, 0.00676866};  // Ace
    }
  }
