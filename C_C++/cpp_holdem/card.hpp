...
class Card {
 public:
  ...
  Card(uchar cardNum);  // 0 = 2Hearts, 1 = 3Hearts, ... , 13 = 2Diamonds, ... ,
                        // 26 = 2Clubs, ... , 50 = KSpades, 51 = ASpades
  ...
  Suit suit_;
  uchar encoding_;  // 7 bits: 4 msbs for suits (S,C,D,H), and 3 lsbs for value
                    // count
  bool isDealt_;
};
