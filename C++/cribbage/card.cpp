...
size_t Card::operator+ (const size_t& num) const
{
    return value_ + num;
}

bool Card::operator== (const size_t& num) const
{
    return value_ == num;
}

size_t Card::operator+ (const Card& c) const
{
