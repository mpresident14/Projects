...
public class ThreadTest implements Runnable{
	...
	public static void main(String args[]) throws InterruptedException {
		Card h1 = new Card(Symbol.TWO, Suit.DIAMONDS);
		Card h2 = new Card(Symbol.JACK, Suit.DIAMONDS);
		
		Card h3 = new Card(Symbol.KING, Suit.DIAMONDS);
		Card h4 = new Card(Symbol.THREE, Suit.SPADES);
		
		Card b1 = new Card(Symbol.ACE, Suit.DIAMONDS);
        Card b2 = new Card(Symbol.ACE, Suit.CLUBS);
        Card b3 = new Card(Symbol.ACE, Suit.HEARTS);
        Card b4 = new Card(Symbol.ACE, Suit.CLUBS);
        Card b5 = new Card(Symbol.QUEEN, Suit.SPADES);
		...
		Player[] players = new Player[] {p1, p2};//, p4, p5, p6, p7, p8, p9};
